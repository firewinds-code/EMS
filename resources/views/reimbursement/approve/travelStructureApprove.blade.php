  <div id="forResponse">
     ...
     <script>
        document.getElementById("edit_food").addEventListener("submit", function(event) {
           ...
           var commentTextarea = document.querySelector("[name='TravelCommentApprover']");
        ...
        function editfoodModal(el) {
           ...
           var reviewComment = tr.find('#reviewComment').text();
           ...
           $('#reviewerStatus_').val(placeTo);
           $('#reviewComment_').val(placeTo);
        }
     </script>
  </div>
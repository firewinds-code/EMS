...
<div id="forResponse">
                  ...
                  <tbody class="fw-semibold text-gray-600">
                     ...
                     <tr>
                        ...
                        <td id="MDownloadRecipt">
                           <a href="{{ asset('reimbursement/ExpenseMobile/' . $employeeData->receipt_image) }}" download>
                        ...
                        <td hidden id="mobileID">{{ $employeeData->id }}</td>
         ...
         <div class="modal-content">
            ...
            <div class="modal-body ">
               <form id="edit_hotel" class="form" method="POST" enctype="multipart/form-data">
                  ...
                  <input type="text" class="form-control" readonly maxlength="10" hidden placeholder="Receipt No" id="mobileID_" name="mobileID_" />
                  <div class="row g-9 mb-8">
                     <div class="col-md-4 fv-row">
                        ...
                        <input type="text" class="form-control" placeholder="Pick date rage" id="mobileDate" name="mobileDate" readonly />
                     </div>
                     <div class="col-md-4 fv-row">
                        <label class="d-flex align-items-center fs-6 fw-semibold mb-2">
                           <span>Amount</span>
                        ...
                        <input type="text" readonly class="form-control" placeholder="Enter Ammount" id="mobileAmount" name="mobileAmount" />
                     </div>
                     <div class="col-md-4 fv-row">
                        <label class="d-flex align-items-center fs-6 fw-semibold mb-2">
                        ...
                        <input type="text" class="form-control" readonly maxlength="10" placeholder="Receipt No" id="mobileReceiptNo" name="mobileReceiptNo" />
                     </div>
                     ...
                     <div class="col-md-6 fv-row">
                        ...
                        <textarea class="form-control" rows="3" name="mobileRemakrs" readonly id="mobileRemakrs" placeholder="Type Comment Details"></textarea>
                     </div>
                     @if ($type === 'approve')
                     <div class="col-md-6 fv-row">
                        <label class="d-flex align-items-center fs-6 fw-semibold mb-2">
                        ...
                        <input type="text" class="form-control" readonly maxlength="10" placeholder="Receipt No" id="hotelStatusReviewer" name="hotelStatusReviewer" />
                     </div>
                     <div class="col-md-6 fv-row">
                        <label class="fs-6 fw-semibold mb-2">Reviewer Remarks</label>
                        <textarea class="form-control" rows="3" name="hotelRemakrsReviewer" readonly id="hotelRemakrsReviewer" placeholder="Type Comment Details"></textarea>
                     </div>
                     ...
                     <div class="d-flex flex-column mb-8">
                        ...
                        <textarea class="form-control" rows="3" name="mobileCommentApprover" placeholder="Type Comment Details"></textarea>
                        <div class="invalid-feedback">
                     ...
                     <div class="d-flex flex-column mb-8">
                        <label class="required">Reviewer Comment</label>
                        <textarea class="form-control" rows="3" name="mobileCommentReviewer" placeholder="Type Comment Details"></textarea>
                        <div class="invalid-feedback">
   ...
   <script>
      ...
      document.getElementById("edit_hotel").addEventListener("submit", function(event) {
         ...
         var commentTextarea = reqType === "review" ? document.querySelector("[name='mobileCommentReviewer']") :
            document.querySelector("[name='mobileCommentApprover']");
      ...
      function editfoodModal(el) {
         ...
         $('#mobileRemakrs').val(MRemakrs);
         $('#mobileReceiptNo').val(mobileReceiptNo);
         $('#mobileID_').val(MobileID);
         var downloadLink = $('#downloadLink');
         var downloadUrl = `{{ asset('reimbursement/ExpenseMobile/') }}/` + mobileReceipt_File;

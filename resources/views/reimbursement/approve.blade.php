...
@section('content')
@section('page-title', 'Approver')
@section('page-heading', 'Reimbursement Approver')
<style>
    .overlay {
        position: fixed;
        top: 0;
        ...
        <div class="card-body">
            <div class="row g-9 mb-8">
                <div class="col-md-6 fv-row">
                    <select class="form-select form-select-solid" data-control="select2" data-placeholder="--select--" name="reimbursement_type">
             ...
             `);
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        $pageOverlay.hide();
                        $('#appendChild').html(response);
                        $('#reimbursement_type').val('null').trigger('change');
                    },
                    error: function(xhr, status, error) {
                        $pageOverlay.hide();
                        console.error(error);

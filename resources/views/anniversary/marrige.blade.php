...
@section('content')
@section('page-title', 'Marriage')
@section('page-heading', 'Marriage-Anniversary')
         ...
         <div class="card">
            <div class="card-body">
               <div class="row g-5 g-xl-10 mb-xl-10">
                  ...
                  @foreach ($get_m_Data as $m_list)
                  @php
                  $ofc_loc = $m_list->location;
                  $locationdir = '';
                              ...
                              <div class="d-flex align-items-center">
                                 ...
                                 <table class="table table-row-bordered table-hover gy-2">
                                    <tr>
                                       ...
                                       <td class="fw-semibold fs-7 text-gray-600 text-dark">{{ $m_list->EmployeeName }}</td>
                                    </tr>
                                    <tr>
                                       <td class="fs-7 fw-bold">Client Name</td>
                                       <td class="fw-semibold fs-7 mt-4 text-gray-600 text-dark">{{ $m_list->client_name }}</td>
                                    </tr>
                                    <tr>
                                       <td class="fs-7 fw-bold">Process</td>
                                       <td class="fw-semibold fs-7 text-gray-600 text-dark">{{ $m_list->process }}</td>
                                    </tr>
                                    <tr>
                                       <td class="fs-7 fw-bold">Sub Process</td>
                                       <td class="fw-semibold fs-7 text-gray-600 text-dark">{{ $m_list->sub_process }}</td>
                                    </tr>
                                    <tr>
                                       <td class="fs-7 fw-bold">Designation</td>
                                       <td class="fw-semibold fs-7 text-gray-600 text-dark">{{ $m_list->Designation }}</td>
                                    </tr>
                                    <tr>
                                       <td class="fs-7 fw-bold">Location</td>
                                       <td class="fw-semibold fs-7 text-gray-600 text-dark">{{ $m_list->locname }}</td>
                                    </tr>
